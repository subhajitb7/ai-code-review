    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
      ...
      <div className="flex flex-col md:flex-row items-center gap-8 mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="relative group">
          <div className={`h-32 w-32 rounded-3xl flex items-center justify-center text-4xl font-bold border-2 transition-all duration-500 shadow-2xl ${
            isAdmin ? 'bg-yellow-500/10 text-yellow-600 border-yellow-500/30' : 'bg-primary-500/10 text-primary-500 border-primary-500/30'
          }`}>
        ...
        <div className="text-center md:text-left">
          <div className="flex items-center justify-center md:justify-start gap-3 mb-2">
            ...
            <span className={`px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider border ${
              isAdmin ? 'bg-yellow-500/10 text-yellow-600 border-yellow-500/20' : 'bg-primary-500/10 text-primary-500 border-primary-500/20'
            }`}>
              {user.role}
            </span>
          </div>
        ...
        <div className="lg:col-span-9 space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
          ...
          <div className="glass-panel overflow-hidden border-col shadow-2xl">
            ...
            <div className="p-8">
              ...
              {resetMessage && (
                <div className={`mt-8 p-4 rounded-2xl flex items-start gap-3 border animate-in slide-in-from-bottom-2 ${
